...
const ReactionMenu = ({ isOpen, onSelect, currentReaction }: ReactionMenuProps) => {
  ...
  return (
    <div className={cn(
      "absolute bottom-full left-1/2 -translate-x-1/2 mb-2 p-3 rounded-xl bg-gray-900/95 border border-gray-800 shadow-lg transition-all duration-200 z-[100] max-w-[90vw] mx-auto",
