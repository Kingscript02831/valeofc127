...
import { Search, Bell, Menu, Phone, Globe, MapPin, Clock, User2, Facebook, Instagram, MessageCircle, ChevronDown, ChevronUp, Wallet } from "lucide-react";
        ...
        <div className="flex flex-col gap-4">
          ...
          {isLoading ? (
            ...
            <p className="text-center py-8 text-red-500">
              Erro ao carregar lojas. Por favor, tente novamente.
            </p>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {stores?.map((store) => {
